...
export default function Sidebar() {
  ...
  return (
    <aside className="w-60 bg-gradient-to-b from-slate-900 via-slate-800 to-slate-900 h-screen p-5 shadow-2xl">
      {/* Logo / Brand */}
      <div className="mb-6">
        <div className="flex items-center gap-2.5 mb-2">
          ...
          <div>
            <h1 className="text-xl font-bold text-white tracking-tight">DataVault</h1>
